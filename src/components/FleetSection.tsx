...
export function FleetSection({ onOpenQuote }: FleetSectionProps) {
  ...
  return (
    <section id="fleet" className="relative py-20 bg-[#f0f5f2] border-b border-[#e1e9e5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-lg bg-[#e7edea] hover:bg-[#dfe8e3] text-slate-700 hover:text-slate-900 border border-[#d8e2dd] transition-colors cursor-pointer"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-[#ebf1ef] rounded-2xl border border-[#dbe5df] p-6 sm:p-8 overflow-hidden shadow-2xl">
          
          {/* Left: Interactive Vehicle Specs */}
          <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
            <div>
              {/* Category tag */}
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-[#e1eae6] border border-[#d3dfd8] text-xs font-mono font-bold text-[#1f6b12]">
            ...
            <div className="grid grid-cols-2 gap-4 py-4 border-y border-[#dde6e1]">
              <div className="bg-[#e7eeeb] p-3.5 rounded-xl border border-[#d9e4de]">
                <div className="flex items-center gap-2 text-xs font-mono text-slate-500">
                  <Gauge className="w-4 h-4 text-[#1f6b12]" />
                  <span>TẢI TRỌNG THIẾT KẾ</span>
                </div>
                <div className="text-lg font-bold text-slate-900 font-heading mt-1 text-[#1f6b12]">
              ...
              <div className="bg-[#e7eeeb] p-3.5 rounded-xl border border-[#d9e4de]">
                <div className="flex items-center gap-2 text-xs font-mono text-slate-500">
                  <Layers className="w-4 h-4 text-[#1f6b12]" />
              ...
              {selectedVehicle.enginePower && (
                <div className="bg-[#e7eeeb] p-3.5 rounded-xl border border-[#d9e4de]">
                  <div className="flex items-center gap-2 text-xs font-mono text-slate-500">
                    <Wrench className="w-4 h-4 text-[#1f6b12]" />
            ...
            <div className="pt-2">
              <button
                onClick={onOpenQuote}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#5cb83a] hover:bg-[#6dd144] text-[#09110e] font-bold text-xs tracking-wider uppercase transition-all shadow-lg shadow-[#1f6b12]/25"
              >
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-4">
            {/* Main Visual */}
            <div className="relative h-72 sm:h-96 rounded-xl overflow-hidden border border-[#d5e0da] group">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#edf3f0] via-transparent to-black/20" />
              
              <div className="absolute bottom-4 left-4 right-4 bg-[#eaf0ed]/90 backdrop-blur-md p-3.5 rounded-lg border border-[#dbe4e0] flex items-center justify-between">
                <div>
                ...
                <span className="text-xs font-mono font-bold text-[#1f6b12] bg-[#e1eae5] px-2.5 py-1 rounded border border-[#d4e0da]">
                  {selectedVehicle.payload}
                </span>
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`p-2.5 rounded-lg text-left transition-all border ${
                      isSelected
                        ? 'bg-[#e3ebe7] border-[#5cb83a] text-slate-900 shadow-md'
                        : 'bg-[#e9efec] border-[#dde5e0] text-slate-500 hover:text-slate-900 hover:border-[#cbd9d1]'
                    }`}
                  >
                    <div className="text-[10px] font-mono font-bold uppercase truncate text-[#1f6b12]">
                      {veh.category}
                    </div>
