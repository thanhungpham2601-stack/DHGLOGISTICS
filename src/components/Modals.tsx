...
export function SurveyModal({ isOpen, onClose }: SurveyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in">
      <div className="bg-[#0e1a14] border border-[#264434] rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl p-6 sm:p-8 relative">
        
        <button
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-lg bg-[#14231b] text-slate-400 hover:text-white border border-[#233b2e]"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {submitted ? (
          <div className="py-8 text-center space-y-4">
            <div className="w-14 h-14 rounded-full bg-[#183324] border border-[#5cb83a] text-[#5cb83a] flex items-center justify-center mx-auto">
            ...
            <div className="pt-4 flex justify-center gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-lg bg-[#14231c] text-slate-300 text-xs border border-[#253e30]"
              >
                Đóng
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <span className="text-xs font-mono text-[#83e05e] font-bold uppercase">
